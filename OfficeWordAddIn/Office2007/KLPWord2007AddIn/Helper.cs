...
namespace KLPWord2007AddIn
{
    class Helper
    {
        ...
        //public List<Tuple<string, string>> Read(string productCodesFilePath)
        //{
        //    DataSet dataset = new DataSet();
        //    //DataTable productCodesTable = new DataTable();

        //    string filename = productCodesFilePath;
        ...
        //        productCodes.Add(new Tuple<string, string>(row[0].ToString(), row[1].ToString()));
        ...
        public List<Tuple<string, string>> Read(string resourceName)
        {
            ...
            //XDocument xDoc = doc.Parse(resourceName);
