...
namespace KLPCommon
{
    public class FødselsnummerValidator
    {
        public Tuple<bool,string> CheckFødselsnummer(string number)
        {
            ...
            {
                result = "Et fødselsnummer består av kun tall";
            ...
            int k1Calculated = 11 - (((3 * d1) + (7 * d2) + (6 * m1) + (1 * m2) + (8 * y1) + (9 * y2) + (4 * i1) + (5 * i2) + (2 * i3)) % 11);
            ...
            int k2Calculated = 11 - (((5 * d1) + (4 * d2) + (3 * m1) + (2 * m2) + (7 * y1) + (6 * y2) + (5 * i1) + (4 * i2) + (3 * i3) + (2 * k1Calculated)) % 11);
